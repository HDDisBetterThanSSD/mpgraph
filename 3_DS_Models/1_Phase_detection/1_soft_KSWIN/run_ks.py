...
import os
import sys
from phase_detection import run_ks_2_phase
...
def main():
    ...
    output_path_root="../../../res/1_Phase_detection/1_soft_KSWIN/"
    ...
    for alg in alg_list:
        for app in app_list:
            ...
            if len(input_file_list) == len(phase_list):
                run_ks_2_phase(input_file_list[0],input_file_list[1],output_file)
